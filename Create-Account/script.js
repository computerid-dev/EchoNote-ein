...
async function isTagnameTaken(tagname){
    ...
    const snap = await firebase.app("auth").firestore()
        .collection("users")
...
document.getElementById("saveBtn").addEventListener("click", async () => {
    ...
    try {
        ...
        const storage = firebase.app("auth").storage();
        ...
        await firebase.app("auth").firestore().collection("users").doc(user.uid).set({
